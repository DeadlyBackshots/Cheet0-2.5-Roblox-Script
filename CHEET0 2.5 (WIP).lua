...
Section1:NewToggle("Gravity Toggle", "This will toggle the Gravity (you will start floating)", function(state)
    ...
    Section2:NewToggle("Universal ESP & Aimbot", "This will toggle both of these cheats (Use right control to toggle the UI)", function(state)
    -- toggle Aimbot & ESP (Universal) --
--If true, 
...
--If false,
    ...
    --If false, 
        ...
        --This is the smoothest and most accurate, but games can detect this easily. Be careful with what games you use false in.
...
Section1:NewKeybind("Toggle UI", "Press F10 to toggle the UI", Enum.KeyCode.F10, function()
	Library:ToggleUI()
end)
